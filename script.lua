        ...
        Callback = function(bool)
            ...
            if bool then
                ka = range.Touched:Connect(function(touching)  
                    if (settings.AttackPlayers and not touched.Parent == char and not touching:FindFirstAncestor("Mobs") and touching.Name == "HumanoidRootPart") or (touching:FindFirstAncestor("Mobs") and touching.Name == "HumanoidRootPart") then
